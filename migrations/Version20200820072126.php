 ...
 */
final class Version20200820072126 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE practitioner (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, job_title VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_17323CBCA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE practitioner ADD CONSTRAINT FK_17323CBCA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
